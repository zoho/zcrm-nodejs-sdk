...
var modules = function modules()
{
    ...
    return {
        ...
        {
            return util.promiseResponse(util.constructRequestDetails(input, input.module + "/{id}/" + input.related, HTTP_METHODS.GET, false));//No I18N
        },
        postRelated : function(input)
        {
            return util.promiseResponse(util.constructRequestDetails(input, input.module + "/{id}/" + input.related, HTTP_METHODS.POST, false));//No I18N
        },
        putRelated : function(input)
        {
            return util.promiseResponse(util.constructRequestDetails(input, input.module + "/{id}/" + input.related, HTTP_METHODS.PUT, false));//No I18N
        },
        deleteRelated : function (input)
        {
            return util.promiseResponse(util.constructRequestDetails(input, input.module + "/{id}/" + input.related, HTTP_METHODS.DELETE, false));//No I18N
        },
