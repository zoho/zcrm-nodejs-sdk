...
ZCRMRestClient.initialize = function(configJSON) {
  ...
  data.client_id = data.client_id || config.get('zoho.crm.clientid') || null;
  data.client_secret = data.client_secret || config.get('zoho.crm.clientsecret') || null;
  data.redirect_url = data.redirect_url || config.get('zoho.crm.redirecturl') || null;
  data.refresh_token = data.refresh_token || config.get('zoho.crm.refreshtoken') || null;
  data.base_url = data.base_url || config.get('crm.api.url') || null;
  data.user_identifier = data.user_identifier || config.get('crm.api.user_identifier') || null;
  data.mysql_module = data.mysql_module || config.get('crm.api.tokenmanagement') || null;
